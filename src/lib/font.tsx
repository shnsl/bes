...
const STORAGE_KEY = "bes-font";
const STYLE_ID = "bes-app-fonts";
...
export function FontProvider({ children }: { children: ReactNode }) {
  ...
  const cycleFont = useCallback(() => {
    setFontIdState((current) => nextFontId(current));
  }, []);
...
export function useFont(): FontContextValue {
  ...
  if (!ctx) throw new Error("useFont yalnızca FontProvider içinde kullanılabilir");
  return ctx;
}
